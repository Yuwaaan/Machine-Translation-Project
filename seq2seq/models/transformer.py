...
class TransformerDecoder(Seq2SeqDecoder):
    ...
    def forward(self, tgt_inputs, encoder_out=None, incremental_state=None, features_only=False):
        ...
        forward_state = forward_state.transpose(0, 1)
        # print('forward_state2: ', forward_state.size())
        ...
        for layer_idx, layer in enumerate(self.layers):
            ...
            # print('encoder_out: ', encoder_out['src_out'].size())
            '''
            ...
            # self_attn_mask.size = [num_features, num_features]
            '''
        ...
        if not features_only:
            ...
            # forward_state.size = [batch_size, tgt_time_steps, len(dictionary)]
            '''
